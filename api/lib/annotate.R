...
# The symbol helpers (enrichment_reference_table, difexp_symbol_column,
# lookup_gene_symbols, lookup_gene_symbols_by_feature_name) live in
# api/lib/symbols.R, shared with the Shiny Annotate module.
