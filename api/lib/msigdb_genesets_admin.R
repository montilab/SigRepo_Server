# Populates the on-disk MSigDB cache and registers it into
...
# gene-symbol vectors -- readRDS(cache_file) always gets this same shape
# back, whichever code reads it.
