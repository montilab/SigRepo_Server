...
send_tmp_password_to_user <- function(
  ...
  msg <- sendmailR::mime_part(
    base::paste0(
      ...
      '<p>Hi <strong>', user_name, ',</strong></p>',
      '<br>',
      '<p>Here is a temporary password to access your account on the <strong>SigRepo</strong> database.</p>',
      '<br>',
      '<p>Username: <strong>', user_name, '</strong></p>',
      '<p>Temporary password: <strong>', tmp_password, '</strong></p>',
      '<br>',
      '<p>We recommend that you log back into our portal and update your password to your preferred one.</p>',
      '<p>To log back in, please follow this link, <strong>https://sigrepo.org/</strong></p>',
      '<br>',
      '<p>Best,</p>',
      '<p>Montilab Team</p>',
