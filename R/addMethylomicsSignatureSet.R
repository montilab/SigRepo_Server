#' @title addMethylomicsSignatureSet
#' @description Add a Methylomics signature feature set into the database
...
#' 
#' @export
addMethylomicsSignatureSet <- function(
    conn_handler,
    signature_id,
    organism_id,
    signature_set,
  ...
  if(nrow(signature_tbl) == 0){
    ...
    if(nrow(lookup_feature_id_tbl) != length(lookup_hashkey)){
      ...
      # Show error message  ## need to fix this 
      SigRepo::showMethylomicsErrorMessage(
        db_table_name = ref_table,
