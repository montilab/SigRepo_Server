#' @title addMetabalomicsFeatureSet
#' @description Add Metabalomics Feature Set into database
...
#' 
#' @export
addMetabalomicsFeatureSet <- function(
    conn_handler,
    feature_set,
    verbose = TRUE
){
  ...
  db_table_name <- "Metabalomics_features"
  table <- feature_set
