...
The `addSignatureCollection()` function allows users to upload a collection to the database. 
...
The `searchCollection()` function allows users to search for all or a specific set of collection that are available in the database. 
...
## Example 2: Search for a specific collection, e.g., **collection_name = "Example_Collection"**.
...
The `updateCollection()` function allows users to update a collection in the SigRepo database. 
...
# Search for updated Example_Collection
collection_tbl <- SigRepo::searchCollection(
  conn_handler = conn_handler, 
  collection_name = "Example_Collection"
)
