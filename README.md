...
#> Finished uploading.
#> ID of the uploaded signature: 7
```
...
#> Adding signature feature set to the database...
#> Finished uploading.
#> ID of the uploaded signature: 8
```
...
|-------------:|:--------------------------|:-------------|:---------------|:----------------|:-----------|:------------|:------------|:----------------------------------------------|:----------------------------|-------------:|-------------:|---------------:|-------------:|:-------------------|:-----------------|---------:|-----:|:---------------------------|-----------:|--------------:|-----------------:|-------------------:|:----------|:--------------------|-----------:|:---------------------------------|
|            7 | Myc_reduce_mice_liver_24m | Mus musculus | bi-directional | transcriptomics | Myc_reduce | GPL6246     | liver       | none                                          | mice MYC reduced expression |            5 |           NA |             NA |         0.05 | NA                 | Myc,KO,longevity | 25619689 | 2015 | animal_strain: \<C57BL/6\> |          1 |           884 |                5 |                 10 | root      | 2025-04-02 15:45:55 |          0 | a97e48241eae7cff270c0341555e90d2 |
|            8 | LLFS_Aging_Gene_2023      | Homo sapiens | bi-directional | transcriptomics | Aging      | GPLXXXXX    | blood       | sex,fc,education,percent_intergenic,PC1-4,GRM | NA                          |            6 |           NA |             NA |         0.01 | NA                 | human,aging,LLFS |       NA | 2023 | NA                         |          1 |         11159 |              882 |                957 | root      | 2025-04-02 15:45:56 |          0 | 7fdecac66691beed1703efc25487768c |
...
#> Remove signature_id = '8' from 'signatures' table of the database.
#> Remove features belongs to signature_id = '8' from 'signature_feature_set' table of the database.
#> Remove user access to signature_id = '8' from 'signature_access' table of the database.
#> Remove signature_id = '8' from 'signature_collection_access' table of the database.
#> signature_id = '8' has been removed.
```
...
#>   [Success] OmicSignature object Myc_reduce_mice_liver_24m created.
#>  signature_id = '7' has been updated.
```
...
| signature_id | signature_name            | organism     | direction_type | assay_type      | phenotype  | platform_id | sample_type | covariates | description                 | score_cutoff | logfc_cutoff | p_value_cutoff | adj_p_cutoff | cutoff_description | keywords         |     PMID | year | others                     | has_difexp | num_of_difexp | num_up_regulated | num_down_regulated | user_name | date_created        | visibility | signature_hashkey                |
|-------------:|:--------------------------|:-------------|:---------------|:----------------|:-----------|:------------|:------------|:-----------|:----------------------------|-------------:|-------------:|---------------:|-------------:|:-------------------|:-----------------|---------:|-----:|:---------------------------|-----------:|--------------:|-----------------:|-------------------:|:----------|:--------------------|-----------:|:---------------------------------|
|            7 | Myc_reduce_mice_liver_24m | Mus musculus | bi-directional | transcriptomics | Myc_reduce | GPLXXXXX    | liver       | none       | mice MYC reduced expression |            5 |           NA |             NA |         0.05 | NA                 | Myc,KO,longevity | 25619689 | 2015 | animal_strain: \<C57BL/6\> |          1 |           884 |                5 |                 10 | root      | 2025-04-02 15:46:00 |          0 | a97e48241eae7cff270c0341555e90d2 |
