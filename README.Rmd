...
omic_signature_1 <- base::readRDS(base::file.path(signature_path, "omic_signature_AGS_1.RDS"))
omic_signature_2 <- base::readRDS(base::file.path(signature_path, "omic_signature_MDA_2.RDS"))
```
